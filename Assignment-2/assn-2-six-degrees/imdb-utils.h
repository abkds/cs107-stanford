...
inline const char *determinePathToData(const char *userSelectedPath = NULL) {
    ...
    if (strcasecmp(ostype, "darwin15") == 0)
        return "/Users/abkds/cs107-stanford/Assignment-2/assn-2-six-degrees-data/little-endian/";
    if (strcasecmp(ostype, "linux") == 0)
        return "/Users/abkds/cs107-stanford/Assignment-2/assn-2-six-degrees-data/little-endian/";
    if (strcasecmp(ostype, "solaris") == 0)
        return "/Users/abkds/cs107-stanford/Assignment-2/assn-2-six-degrees-data/big-endian/";
